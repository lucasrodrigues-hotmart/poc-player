...
//        val url = "https://api.sparkleapp.com.br/rest/v2/news/207274/download"
    ...
    private fun playMedia(mediaUrl : String) {
        ...
        val loadControl = DefaultLoadControl.Builder().setBufferDurationsMs(100, 500, 100, 100).createDefaultLoadControl()
        val simpleExoPlayer = SimpleExoPlayer.Builder(this).build().apply {//.setLoadControl(loadControl).build().apply {
            playWhenReady = true
            prepare(videoSource)
        }
